...
//Reference: bluerov2 6DOF model in component form: Chapter 3.6
//https://liu.diva-portal.org/smash/get/diva2:939494/FULLTEXT01.pdf
...
int main()
{
   ...
   // mpc.set(CG_HARDCODE_CONSTRAINT_VALUES, YES);  // Possible to Change Constraints Afterwards (only with qpOASES)
    ...
    std::string path_dir = path + "/solver/NMPC_BlueRov2_3-D";           // Set the name of the folder that contains the acado c-code solver files
